...
//
//// TODO: fixme log in TEST_USER_0 before any test
...
//        val secondTrophyWon = TEST_USER_0.trophiesWon[1]
...
//        val notWonTrophy = allTrophies.first { !TEST_USER_0.hasTrophy(it.getId()) }
